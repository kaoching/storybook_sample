...
describe.only('getStorybookMetadata', () => {
  ...
  it('should return storiesPath with default glob from CSF3 style config', () => {
    ...
    expect(storiesPaths).toMatchInlineSnapshot(`"<rootDir>/stories/basic/**/*.stories.@(mdx|tsx|ts|jsx|js)"`);
  });
  ...
  it('should return storiesPath from mixed CSF2 and CSF3 style config', () => {
    ...
    expect(storiesPaths).toMatchInlineSnapshot(`"<rootDir>/stories/basic/**/*.stories.@(mdx|tsx|ts|jsx|js);<rootDir>/stories/complex/*.stories.@(js|ts)"`);
  });
});