 ...
 */
export declare const transformUserWebhookEventEnumToJSON: (value: UserWebhookEventEnum) => any;
export declare const transformJSONToUserWebhookEventEnum: (value: any) => UserWebhookEventEnum;
/**
 *
 * @export
 * @enum {string}
 */
export declare enum UserWebhookEventEnum {
    STAR = "*",
    PROJECT = "project.*",
