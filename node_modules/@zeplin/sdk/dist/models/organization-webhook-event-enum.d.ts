 ...
 */
export declare const transformOrganizationWebhookEventEnumToJSON: (value: OrganizationWebhookEventEnum) => any;
export declare const transformJSONToOrganizationWebhookEventEnum: (value: any) => OrganizationWebhookEventEnum;
/**
 *
 * @export
 * @enum {string}
 */
export declare enum OrganizationWebhookEventEnum {
    STAR = "*",
    PROJECT = "project.*",
